...
def _build_context(intent, symbol=None):
    ...
    # V10.2 BUG 1 FIX: safe_float helper - NaN values ko default mein convert karta hai.
    # float('nan') or 0 = nan (bug!), kyunki bool(float('nan')) = True.
    # math.isnan() se explicit check karte hain.
    ...
    if symbol:
        try:
            ...
            if df is not None and len(df) >= 30:
                ...
                # V10.2 BUG 1 FIX: safe_float use kiya gaya — NaN values ab 0.0 return honge
